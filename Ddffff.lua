...
local HopServerTab, HopServerPage = TabsManager:RegisterTab("เซิร์ฟ69", 6, "HOP_SERVER")

-- ==================================================
-- CONTENT
-- ==================================================
CreateSectionTitle(HopServerPage, "เซิร์ฟ69", 1)
...
FeatureName.Text = "กดปุ่มข้างขวา "
...
local function CreateEntry(index, server)
    ...
    JobLabel.Text = "เลขเซิร์ฟโง่ๆ : " .. server.id
...
ClickBtn.MouseButton1Click:Connect(function()
    ...
    FeatureStatus.Text = "BOSS69 " .. #servers .. " เซิร์ฟ ทุกเซิร์ฟ มี1 คนเลือกเข้าได้เลย."
    FeatureStatus.TextColor3 = Color3.fromRGB(0, 255, 105)
end)
